...
3. Click **Load unpacked**, or **Reload** if it is already loaded
4. Select this `extension/` folder
5. Open **Options** and choose Local or Production
6. Allow LinkedIn and Reddit if Chrome asks
...
If the post text is truncated, expand “see more” first, then open the clipper again.
